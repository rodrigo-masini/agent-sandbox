    ...
    async def render(self):
        ...
        with ui.column().classes('w-full h-full bg-black'):
            ...
            with ui.row().classes('w-full bg-gray-800 p-2'):
                ...
                ui.space()
                ui.button(icon='clear_all', on_click=self.clear_terminal).props('flat color=white dense')
            ...
            with ui.row().classes('w-full bg-gray-900 p-2'):
                ...
                self.input_field = ui.input(
                    ...
                    on_change=self.handle_enter
                ).classes('flex-grow bg-black text-green-400 font-mono').props('outlined dense dark')
